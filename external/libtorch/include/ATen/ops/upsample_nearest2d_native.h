...
TORCH_API at::Tensor & upsample_nearest2d_vec_out(const at::Tensor & input, at::OptionalIntArrayRef output_size, c10::optional<at::ArrayRef<double>> scale_factors, at::Tensor & out);
