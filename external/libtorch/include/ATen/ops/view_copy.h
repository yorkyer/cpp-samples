...
inline at::Tensor view_copy(const at::Tensor & self, at::IntArrayRef size) {
    return at::_ops::view_copy::call(self, c10::SymIntArrayRef::fromIntArrayRef(size));
}
...
inline at::Tensor & view_copy_out(at::Tensor & out, const at::Tensor & self, at::IntArrayRef size) {
    return at::_ops::view_copy_out::call(self, c10::SymIntArrayRef::fromIntArrayRef(size), out);
}
