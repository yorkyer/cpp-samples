...
struct TORCH_API upsample_nearest1d_vec_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "upsample_nearest1d.vec_out(Tensor input, int[]? output_size, float[]? scale_factors, *, Tensor(a!) out) -> Tensor(a!)")
