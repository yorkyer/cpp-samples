...
inline at::Tensor matrix_rank(const at::Tensor & self, double tol, bool symmetric=false) {
    return at::_ops::matrix_rank_tol::call(self, tol, symmetric);
}

// aten::matrix_rank(Tensor self, bool symmetric=False) -> Tensor
inline at::Tensor matrix_rank(const at::Tensor & self, bool symmetric=false) {
