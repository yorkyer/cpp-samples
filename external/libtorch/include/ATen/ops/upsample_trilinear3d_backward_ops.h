...
struct TORCH_API upsample_trilinear3d_backward_vec_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "upsample_trilinear3d_backward.vec_out(Tensor grad_output, int[]? output_size, int[] input_size, bool align_corners, float[]? scale_factors, *, Tensor(a!) out) -> Tensor(a!)")
