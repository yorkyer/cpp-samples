...
TORCH_API at::Tensor & set_source_Storage_storage_offset_out(const at::Tensor & self, at::Storage source, int64_t storage_offset, at::IntArrayRef size, at::IntArrayRef stride, at::Tensor & out);
