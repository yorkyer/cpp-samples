...
struct TORCH_API upsample_nearest3d_vec_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "upsample_nearest3d.vec_out(Tensor input, int[]? output_size, float[]? scale_factors, *, Tensor(a!) out) -> Tensor(a!)")
