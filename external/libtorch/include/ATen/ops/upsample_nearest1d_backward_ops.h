...
struct TORCH_API upsample_nearest1d_backward_vec_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "upsample_nearest1d_backward.vec_out(Tensor grad_output, int[]? output_size, int[] input_size, float[]? scale_factors, *, Tensor(a!) out) -> Tensor(a!)")
